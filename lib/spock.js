...
const SPOTIFY_REGEX = /(spotify:[a-zA-Z0-9]{22}|spotify:track:[a-zA-Z0-9]{22}|https:\/\/[a-z]+\.spotify\.com\/track\/[a-zA-Z0-9]{22})/ig;
...
class Spock {
  ...
  constructor(clientId, clientSecret) {
    ...
    this.spotifyApi = new SpotifyWebApi({
      ...
      redirectUri: 'https://slack-spock.herokuapp.com/return'
    });
